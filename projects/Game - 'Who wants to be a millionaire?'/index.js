    ...
    let out = `
        <div class="start block"> 
            <div class="start__text">
                ...
                Вам нужно ответить на как можно больше вопросов. Если вы ответили на 5 и 10 вопросы, то вы можете забрать несгораемую сумму. Наш главный приз 1 000 000. Так же вы можете воспользоваться такими подсказками:
                <ul>
                    <li>50 на 50</li>
                    <li>Звонок другу</li>
                </ul>
